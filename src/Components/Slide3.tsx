...
const Slide3 = () => {
  const pagination = {
    clickable: true,
    bulletClass:
      "w-2 h-2 rounded-lg bg-slate-300 inline-block relative mr-4 bottom-20 cursor-pointer z-50",
    ...
    >
      <SwiperSlide>
        <div className="absolute bottom-[8%] left-[4%] ms:bottom-[7%] w-[90%]">
          ...
          <div
            className="text-white text-start pb-5 w-[100%]"
      ...
      <SwiperSlide>
        <div className="absolute bottom-[8%] ms:bottom-[8.5%] left-[2.5%] w-[80%]">
          ...
          <div
            className="text-white text-start pb-5 w-[80%]"
            data-swiper-parallax="-200"
          >
            Never Play the Same
          </div>
      ...
      <SwiperSlide>
        <div className="absolute bottom-[8%] ms:bottom-[7%] left-[4%] w-[90%]">
          ...
          <div
            className="text-white text-start pb-5 w-[90%]"
            data-swiper-parallax="-200"
          >
